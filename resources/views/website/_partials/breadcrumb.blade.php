...
$breadcrumb_description ??
'Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure aut, provident distinctio nobis nesciunt enim. Atque qui
quasi itaque voluptatum dignissimos corrupti perspiciatis, beatae dolor vel?';
@endphp

<div class="container-fluid Breadcrumb">
    <img src="{{ $breadcrumb_image_path }}" alt="{{ $breadcrumb_image_alt }}" loading="lazy" decoding="async"
        class="crumb-img" />
