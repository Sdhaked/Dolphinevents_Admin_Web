                        ...
                        <div>
                            <div class="action-row">
                                <button class="action-btn edit"
                                        data-url="{{ route('admin.event.sliders.info.update', $slide->id) }}"
                                        data-image="{{ asset('storage/' . $slide->image) }}"
                                        data-text="{{ $slide->alt_text }}"
                                        data-link="{{ $slide->url }}"
                                        data-media-delete-url="{{ route('admin.media.destroy', ['target' => 'event-info-slider-record', 'id' => $slide->id]) }}">
                                    <i class="fa-regular fa-pen-to-square"></i>
                                </button>
                                <button class="action-btn delete"
                                        data-url="/admin/events/sliders/info-slider/destroy/{{ $slide->id }}">
