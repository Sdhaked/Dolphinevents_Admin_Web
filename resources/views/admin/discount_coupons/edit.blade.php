...
@section('head')
    ...
    <meta name="description" content="Edit discount coupon for your event.">
...
@section('body')
    ...
    <section class="wrapper">
        <main class="dash-content">
            ...
            <h5 class="hd-lg">Edit Discount Coupon</h5>
            <form action="{{ route('admin.discount.coupons.update', $coupon->id) }}" method="POST" novalidate=""
                ...
                <div class="grid-2 grid-sm-1 gap-card">
                    ...
                    <div class="form-floating">
                        <input type="text" name="title" class="form-control @error('title') is-invalid @enderror"
                               id="title" value="{{ old('title', $coupon->title) }}" required>
                    ...
                    <div class="form-floating">
                        <input type="text" name="coupon_code" class="form-control @error('coupon_code') is-invalid @enderror"
                               id="coupon_code" value="{{ old('coupon_code', $coupon->coupon_code) }}" oninput="this.value = this.value.toUpperCase()" required>
                ...
                <div class="grid-2 grid-sm-1 gap-card">
                    ...
                    <div class="form-floating">
                        <input type="text" name="associate_name" class="form-control @error('associate_name') is-invalid @enderror"
                               id="associate_name" value="{{ old('associate_name', $coupon->associate_name) }}" required>
                    ...
                    <div class="input-group mb-3">
                        <div class="form-floating flex-grow-1">
                            <input type="number" name="discount" class="form-control @error('discount') is-invalid @enderror"
                                   id="discount" step="0.01" min="0" max="100" value="{{ old('discount', $coupon->discount) }}" required>
                ...
                <div class="form-floating">
                    <textarea name="also_associate" class="form-control @error('also_associate') is-invalid @enderror"
                              style="height: 100px" id="also_associate">{{ old('also_associate', $coupon->also_associate) }}</textarea>
                            ...
                            <div class="col-md-4 col-sm-6 mb-2">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="ticket_type_ids[]"
                                           ...
                                           {{ in_array($ticketType->id, old('ticket_type_ids', $coupon->ticket_type_ids ?? [])) ? 'checked' : '' }}>
